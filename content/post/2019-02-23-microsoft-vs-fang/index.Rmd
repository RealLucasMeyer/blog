---
title: MSFT vs FANG, an example of being misled by time-series graphs
...
# Plot time-series graph (plot will call plot.xts because combined_series is a xts object)
plot(combined_series, col=c("blue","red"), legend.loc="topleft", main="MSFT vs. FANG", auto.legend=TRUE)
...
# Calculate the returns backwards, to find out how much I'd have today if I invested $1000
...
combined_series_reversed = xts(merge(msft_cumulative_ret_reverse, fang_cumulative_ret_reverse))
colnames(combined_series_reversed) <- c("MSFT", "FANG")
plot(combined_series_reversed, col=c("blue","red"), legend.loc="topleft", main="MSFT vs. FANG (reversed)", auto.legend=TRUE)
